...
const float BOSS_BB_WIDTH = 120.f;
const float BOSS_BB_HEIGHT = 160.f;
...
const std::vector<std::string> tenant_dialogue_1 = {
    "Thank you so much for saving me! Our landlord has started practing black \n magic, and it's infested our building with demons!",
